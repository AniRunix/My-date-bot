...
async def cmd_start(message: types.Message):
    ...
    await message.answer(
        f"Привет! Дата отсчета установлена на **{DEFAULT_DATE_STR}**.\n\n"
        f"• Отправь команду /date, чтобы получить сообщение.\n"
        f"• Каждую полночь в **00:00 (МСК+3)** я буду присылать его автоматически.\n"
